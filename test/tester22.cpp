...
int main()
{
	...
	for (deque<int>::iterator it = dek1.begin(); it != dek1.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek1.rbegin(); it != dek1.rend(); it++)
	...
	for (deque<int>::iterator it = dek2.begin(); it != dek2.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek2.rbegin(); it != dek2.rend(); it++)
		std::cout << "^" << *it << std::endl;

	std::cout << "===Fill constructor to empty===" << std::endl;
	deque<int> dek3(0,10);
	std::cout << dek3.size() << std::endl;
	for (deque<int>::iterator it = dek3.begin(); it != dek3.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek3.rbegin(); it != dek3.rend(); it++)
		std::cout << "^" << *it << std::endl;

	std::cout << "===Fill constructor with default values===" << std::endl;
	deque<int> dek4(15);
	std::cout << dek4.size() << std::endl;
	for (deque<int>::iterator it = dek4.begin(); it != dek4.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek4.rbegin(); it != dek4.rend(); it++)
		std::cout << "^" << *it << std::endl;

	std::cout << "===Fill constructor with implicit cast===" << std::endl;
	deque<int> dek5(8,'b');
	std::cout << dek5.size() << std::endl;
	for (deque<int>::iterator it = dek5.begin(); it != dek5.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek5.rbegin(); it != dek5.rend(); it++)
		std::cout << "^" << *it << std::endl;

	std::cout << "===Range constructor with empty deque===" << std::endl;
	deque<int> dek6(dek3.begin(), dek3.end());
	std::cout << dek6.size() << std::endl;
	for (deque<int>::iterator it = dek6.begin(); it != dek6.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek6.rbegin(); it != dek6.rend(); it++)
		std::cout << "^" << *it << std::endl;
	...
	for (deque<int>::iterator it = dek7.begin(); it != dek7.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek7.rbegin(); it != dek7.rend(); it++)
		std::cout << "^" << *it << std::endl;	
	
	std::cout << "===Range constructor with reverse iterator===" << std::endl;
	deque<int> dek8(dek5.rbegin(), dek5.rend());
	std::cout << dek8.size() << std::endl;
	for (deque<int>::iterator it = dek8.begin(); it != dek8.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek8.rbegin(); it != dek8.rend(); it++)
		std::cout << "^" << *it << std::endl;
	...
	for (deque<int>::iterator it = dek9.begin(); it != dek9.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek9.rbegin(); it != dek9.rend(); it++)
		std::cout << "^" << *it << std::endl;	
	...
	for (deque<int>::iterator it = dek10.begin(); it != dek10.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek10.rbegin(); it != dek10.rend(); it++)
		std::cout << "^" << *it << std::endl;	
	
	std::cout << "===Copy constructor===" << std::endl;
	deque<int> dek11(dek5);
	std::cout << dek11.size() << std::endl;
	for (deque<int>::iterator it = dek11.begin(); it != dek11.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek11.rbegin(); it != dek11.rend(); it++)
		std::cout << "^" << *it << std::endl;	
	
	std::cout << "===Copy constructor with empty deque===" << std::endl;
	deque<int> dek12(dek3);
	std::cout << dek12.size() << std::endl;
	for (deque<int>::iterator it = dek12.begin(); it != dek12.end(); it++)
		std::cout << "_" << *it << std::endl;
	for (deque<int>::reverse_iterator it = dek12.rbegin(); it != dek12.rend(); it++)
		std::cout << "^" << *it << std::endl;	
